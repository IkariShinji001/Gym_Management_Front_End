<template>
  <div>
    <div class="service-btns-container">
      <q-btn-dropdown flat size="22px" :label="selectedType || 'Phân loại'" class="btn-dropdown-type"
        dropdown-icon="format_list_bulleted">
        <q-list>
          <q-item clickable v-close-popup @click="fileterServicePackageByTypeId(0)">
            <q-item-section>
              <q-item-label class="type-item">Tất cả</q-item-label>
            </q-item-section>
          </q-item>
          <q-item v-for="(type, index) in packageTypes" clickable v-close-popup :key="index"
      ...
      <q-btn-dropdown flat size="22px" label="Cập nhật" class="btn-dropdown-update" dropdown-icon="settings">
        <q-list>
          ...
          <q-item clickable v-close-popup @click="showCreateFitnessPackage = true">
            <q-item-section side>
    ...
    <div class="service-cards-container">
      <div class="service-card" v-for="(fitness, index) in filteredFitnessPackages" :key="index">
        ...
        <div class="service-content">
          <q-tab-panels class="tab-panels" v-model="tab[index]" animated swipeable vertical transition-prev="jump-up"
              ...
              <div class="text-h5 q-mb-md title">
                ...
                <div class="edit-btns">
                  <button class="edit-btn">
                    <q-icon name="edit" size="24px" @click="updateFitnessHandler(fitness)"></q-icon>
                  </button>
                  <button class="edit-btn">
                    <q-icon name="delete" size="24px" @click="confirmDeleteFitnessHandler(fitness)"></q-icon>
                  </button>
                </div>
              </div>
            ...
            <q-tab-panel name="tables" class="table-tab">
              ...
              <div>
                <ul class="responsive-table">
                  ...
                  <li class="table-row" v-for="packagePrice in fitness.servicePackage
                    .servicePackagePrices" :key="packagePrice.id">
                    <div class="col col-1">
    ...
    <q-dialog v-model="showCreateFitnessPackage">
      <q-card class="update-package-type-card">
        <AddFitnessPackageForm :durationList="durationList" :packageTypes="packageTypes"
          @addCreatedFitness="addCreatedFitness" @closeForm="closeForm"></AddFitnessPackageForm>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="showUpdateFitnessPackage">
      <q-card class="update-package-type-card">
        <UpdateFitnessPackageForm :durationList="durationList" :packageTypes="packageTypes"
          :selectedFitness="selectedUpdateFitnessPackage" @addCreatedFitness="addCreatedFitness" @closeForm="closeForm">
      ...
      <q-card class="q-card-package-type">
        ...
        <q-card-section>
          <q-form @submit="createPackageType" class="q-gutter-md">
            <q-input filled v-model="packageTypeInput.type" label="Package Type *" hint="Service package type"
              lazy-rules :rules="[
      ...
      <q-card class="q-card-package-type">
        ...
        <q-card-section>
          <q-form @submit="createDurationHandler" class="q-gutter-md">
            <q-input v-model="durationInput.duration" filled label="Thời hạn *" hint="Thời hạn gói tập" required
              type="number" :rules="[
              ...
              VND</q-input>
            <q-select style="width: 160px" filled v-model="durationInput.durationType" :options="durationTypeList"
              label="Chọn thời gian" class="q-select" map-options lazy-rules emit-value :rules="[
    ...
    <q-dialog v-model="showUpdatePackageType">
      <q-card class="update-package-type-card">
        <UpdatePackageTypeForm :typeList="packageTypes" @deletedType="deletedType"></UpdatePackageTypeForm>
      </q-card>
    </q-dialog>
    ...
    <q-dialog v-model="showDeleteConfirmationDialog">
      <q-card>
        ...
        <q-card-actions align="right">
          ...
          <q-btn flat label="Có" color="negative" @click="deleteFitnessHandler" v-close-popup />
        </q-card-actions>
      </q-card>
    </q-dialog>
  </div>
