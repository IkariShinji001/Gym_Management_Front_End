    ...
    <div class="select-container">
      <div class="date-container">
        ...
        <div class="date-input-container">
          <q-input class="date-input" outlined v-model="dateInput" mask="####/##/##" label="Chọn ngày">
            <template v-slot:prepend>
              <q-icon name="event" class="date-icon">
                <q-popup-proxy cover transition-show="scale" transition-hide="scale">
                  <q-date v-model="dateInput" mask="YYYY/MM/DD" @input="dateInput">
      ...
      <div class="month-year-container">
        ...
        <div class="month-year-select-container">
          <q-select class="month-select" filled color="purple-12" v-model="selectedMonth" :options="monthList"
            label="Label">
            <template v-slot:prepend>
              <q-icon class="month-year-icon" name="event" />
            </template>
          </q-select>
          <q-select class="year-select" filled color="purple-12" v-model="selectedYear" :options="yearList"
            label="Label">
            <template v-slot:prepend>
              <q-icon class="month-year-icon" name="event" />
            </template>
...
<style scoped>
  ...
  .select-container .month-year-container .month-year-select-container .month-select,
  .year-select {
    width: 150px;
  }
